const siheung_model_matrix1 = new Ditap.Transforms.headingPitchRollToFixedFrame(
...
const siheung_model1 = Ditap.Model.fromGltf({
    id: "lx_jeonju",
    url: "public/glb/siheung/siheung_demonstration.glb",
    modelMatrix: siheung_model_matrix1,
});
