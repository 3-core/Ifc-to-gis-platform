...
public class ProxyService {
    ...
    // GeoServer 주소 => 수정필요
    private String geoserverUrl = "http://192.168.40.121:8080/geoserver";
    ...
    public ResponseEntity<byte[]> tileMap001(HttpServletRequest request) {
        ...
        // 레이어명, 스타일(default=raster), 타일포맷, 그리드셋, 레벨, row, col => 수정필요
        return getTileMapImageFromGeoServer("jgh:temp_layer", "raster", "image/png", "EPSG:4326_JGH", "EPSG:4326_JGH:"+tileMatrix, tileRow, tileCol);
    }
